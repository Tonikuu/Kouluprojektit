...
function kertoma() {
  ...
  document.getElementById("tulos4").innerHTML =
    "<p>Luvun " + luku + " kertoma on " + kertoma + "</p>";
}
...
function suurinPienin() {
  ...
  document.getElementById("tulos9").innerHTML =
    "<p>Pienin luku: " +
    taulu[0] +
    "<br> ja suurin luku on: " +
...
function kaksiNumeroa() {
  ...
  document.getElementById("tulos11").innerHTML =
    "<p>Parilliset numerot: " +
    pluvut +
    " ja niiden summa: " +
    psumma +
    "</p><p>Parittomat luvut: " +
    rluvut +
    " ja niiden summa: " +
    rsumma +
    "</p>";
